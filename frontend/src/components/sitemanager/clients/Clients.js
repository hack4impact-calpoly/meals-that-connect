...
const Table = (props) => {
    ...
    const columns = React.useMemo(
        () => [
          ...
          { Header: 'More Details',
            width: 100,
            Cell: row => (<div style={{textAlign: 'center', width: 100}} onClick={() => editClient(row.row.original._id)}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
